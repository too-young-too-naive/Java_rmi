...
public class Skeleton<T> {
    ...
    public Skeleton(Class<T> c, T server) throws Error, NullPointerException {
        ...
        if (server == null) {
            throw new NullPointerException("The remote object is null.");
        }
    ...
    public synchronized void start() throws RMIException {
        ...
        try {
            ...
            listenerThread = new ConnectionListenerThread(serverSocket, this);
            listenerThread.start();
        } catch (IOException e) {
            System.err.println(e.getMessage());
            throw new RMIException("Listening socket cannot be created or bound.");
        }
    }
     ...
     * @return true/false
     */
    private boolean implRemoteInterface(Class<T> c) {
        if (!c.isInterface()) {
            return false;
        }
